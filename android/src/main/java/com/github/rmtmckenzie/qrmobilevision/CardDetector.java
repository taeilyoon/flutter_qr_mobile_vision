...
class CardDetector implements OnSuccessListener<Map<string, string>>, OnFailureListener {
    ...
    CardDetector(QrReaderCallbacks communicator, BarcodeScannerOptions options) {
